...
//INÍCIO VINICIUS 			        
		...
		do {
			...
			if (desejaEntraNoSite == 'S' || desejaEntraNoSite == 's') {
				tituloTabela();
				for (contador = 0; contador < 10; contador++) {
					System.out.print("\n\t♥     " + codProduto[contador] + " \t♥\t" + produto[contador] + "\t♥\t"
							+ preco[contador] + "\t   ♥\t  " + estoque[contador] + "\t   ♥");
				}
				linha(true);
//FIM VINICIUS 
//INÍCIO ANA 
						...
						if (auxCod.equals(codProduto[contador])) {
							...
							for (contador = 0; contador < 10; contador++) {
								if (carrinhoCompras[contador] != 0) {
									System.out.print("♥     " + codProduto[contador] + " \t♥\t" + produto[contador]
											+ "\t♥\t" + preco[contador] + "\t   ♥\t  " + carrinhoCompras[contador]
											+ "\t♥\t" + (carrinhoCompras[contador] * preco[contador]) + "\t    ♥\n");
								}
							}
							linha(false);
						}
...
//INÍCIO GIOVANNA 
				...
				for (contador = 0; contador < 10; contador++) {
					if (carrinhoCompras[contador] != 0) {
						System.out.printf("♥     " + codProduto[contador] + " \t♥\t" + produto[contador] + "\t♥\t"
								+ preco[contador] + "\t   ♥\t  " + carrinhoCompras[contador] + "\t♥\t"
								+ (carrinhoCompras[contador] * preco[contador]) + "\t    ♥\n");
				...
				if (opcao == 1) {
					for (contador = 0; contador < 10; contador++) {
						if (carrinhoCompras[contador] != 0) {
							System.out.println("♥     " + codProduto[contador] + " \t♥\t" + produto[contador] + "\t♥\t"
									+ preco[contador] + "\t   ♥\t  " + carrinhoCompras[contador] + "\t♥\t"
									+ carrinhoCompras[contador] * preco[contador] + "\t    ♥");
						}
					}
					...
					System.out.print("\t\t\t\t\tData de emissão : " + formatterData.format(agora) + "\t    Hora : "
